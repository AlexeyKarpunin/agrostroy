          ...
          <div className='super-circle is-hangar'>
            <div className='super-circle__inner'>
              ...
              <div className='super-circle__inner2'>
                <img className='in-super-circle' src='https://agrostroitel.ru/wp-content/uploads/2019/08/sborno-razbornyi-angar-header.png' alt='Сборно-разборные' ангары='' />
              </div>
            </div>
          </div>        
          {' '}
          <div className='dop-list'>      
            <div className='label__list2'>
              ...
              <div className='label__box'>
                ...
                <div className='label__value-inner label__value-inner2'>Легкость и быстрота монтажа</div>     
              </div>
              
              <div className='label__box'>
                <div className='label__point label__point2' />          
                <div className='label__value-inner label__value-inner2'>Без капитального строительства</div>     
              </div>
              
              <div className='label__box'>
                <div className='label__point label__point2' />          
                <div className='label__value-inner label__value-inner2'>Возможность транспортировки</div>     
              </div>
              
              <div className='label__box'>
                <div className='label__point label__point2' />          
                <div className='label__value-inner label__value-inner2'>Возможность доукомплектовывать конструкцию</div>     
              </div>
              
              <div className='label__box'>
                <div className='label__point label__point2' />          
                <div className='label__value-inner label__value-inner2'>Экономия на проектных работах</div>     
              </div>
              
              <div className='label__box'>
                <div className='label__point label__point2' />          
                <div className='label__value-inner label__value-inner2'>Облегченный фундамент</div>     
              </div>
              
              <div className='label__box'>
                <div className='label__point label__point2' />          
                <div className='label__value-inner label__value-inner2'>Не требуется тяжелая техника</div>     
              </div>
            </div>  
          </div>
          {' '}
