      ...
      <div className='banner'>
          ...
          <div className='banner__notice-inner'>
            <div className='banner__title'>
              <h1 className='in-banner'>
                <p>
                  <span className='text is-primary'>Производство</span>
                  <br />
                  <em className='text is-block'>металлоконструкций</em>
        ...
        <div className='banner__image'>
          <div className='banner__image-inner'>
            <img src='https://agrostroitel.ru/wp-content/uploads/2019/08/Слой-173.png' alt='Металлоконструкции' />
          </div>
