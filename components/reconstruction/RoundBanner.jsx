          ...
          <div className='super-circle is-hangar'>
            <div className='super-circle__inner'>
              ...
              <div className='super-circle__inner2'>
                <img className='in-super-circle' src='https://agrostroitel.ru/wp-content/uploads/2019/08/new-angar-header.png' alt='Реконструкция' зданий='' и='' построек='' из='' металлоконструкций='' />
              </div>
            </div>
          </div>        
          {' '}
